...
<script type ="text/babel">
    ...
    class SearchForm extends React.Component {
        render() {
            return (
                    <form method="post" action="searchEmployees.htm" className="form-inline pt-1 pb-2 w-100"> 
                        ...
                        <input type="text" placeholder="Search.." nameName="search" class="form-control my-1 mr-sm-2" />
                    </form>
            );
        }
    }
                    ...
                    <div className="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    ...
                                    <form method="post" action="editEmployees.htm">
                                        <div className="modal-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="text" id="editEmail" name="editEmail" className="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" />
                                            </div>   
                                            <div className="form-group">
                                                <label for="editManagerID">Employee Manager ID: 
                                                </label> <input type="text" id="editManagerID" name="editManagerID" className="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" />
                                            </div>
                                            <div className="form-group">
