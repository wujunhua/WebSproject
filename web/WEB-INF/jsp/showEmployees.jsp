...
<body class="bg-light">
    ...
    <div class="container-fluid bg-white" style="height: 100vh;">
        <div class="container pb-5 pt-3">
            ...
            <form:form method="post" action="/WebSproject/searchEmployees.htm" class="form-inline pt-1 pb-2">       
                <button class="btn btn-primary btn-sm rounded-0 px-3 mr-2" type="submit"><i class="fas fa-search pr-1"></i>Search</button>
